...
exports.admin = (req, res) => {
  ...
  // GET /admin/{tool} => renders page for that tool
    ...
    res.render(`admin/${toolName}`, { pageTitle: 'Admin' }, err => {
      console.error(err);
...
exports.languages = (req, res) => {
  ...
  if (req.params.language) {
    ...
    res.render(`languages/${langName}`, { pageTitle: title }, err => {
      console.error(err);
...
exports.sandbox = (req, res) => {
  ...
  if (project) {
    ...
    res.render(`sandbox/${project}`, { pageTitle: capitalize(project) }, err => {
      console.error(err);
